...
* **対応項目**：「標準的なバス情報フォーマット(GTFS/GTFS-JP/GTFSリアルタイム)対応」を謳っているシステムも、その対応項目はまちまちです。必要な情報の出力に対応していない場合や、新たなデータ整備が必要になる場合があります。本解説ページの[データ整備事例](examples.md)や、各社の製品情報や問い合わせ結果を参考にしてください。
...
* 動的データ
  - 国土交通省「[標準的なバス情報フォーマット 動的データ（GTFSリアルタイム）ガイドライン](gtfs-realtime.md)」
...
* 説明ページ：https://support.google.com/transitpartners/answer/6377383?hl=ja
...
オープンデータ等としてデータ配信を配信する場合の留意点については、「[配信方法ガイドライン](distribution.md)」を参照してください。

### 経路検索事業者への提供

経路検索事業者へ提供する際の留意点については、「[経路検索事業者へのデータ提供](contents_providers.md)」を参照してください。
